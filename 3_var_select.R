...
even_wave_var <- c("sex", "birthm", "birthy", "dvage", "qfhigh_dv", "hiqual_dv", "racel_dv", "gor_dv", "finfut", "finnow", "hhorig", "ppid", "intdatm_dv", "intdaty_dv", "marstat_dv", "jbstat", "jbisco88_cc", "jbterm1", "jbterm2", "jbhrs", "jbot", "jbsect", "jbsectpub", "jbpl", "jbsat")

odd_wave_var <- c("sex", "birthm", "birthy", "dvage", "qfhigh_dv", "hiqual_dv", "racel_dv", "gor_dv", "finfut", "finnow", "hhorig", "jbsec", "ppid", "intdatm_dv", "intdaty_dv", "marstat_dv", "jbstat", "jbisco88_cc", "jbterm1", "jbterm2", "jbhrs", "jbot", "jbsect", "jbsectpub", "jbpl", "jbsat")
...
col_order <- c("pidp", "wave", "sex", "birthm", "birthy", "dvage", "qfhigh_dv", "hiqual_dv", "racel_dv", "gor_dv", "finfut", "finnow", "hhorig", "jbsec", "ppid", "intdatm_dv", "intdaty_dv", "marstat_dv", "jbstat", "jbisco88_cc", "jbterm1", "jbterm2", "jbhrs", "jbot", "jbsect", "jbsectpub", "jbpl", "jbsat")
...
#adding partnership and partner's employment details
...
x_sample2 <- xwave %>% #not to be confused with x_sample located in scripts 2)
...
#Make new variables for objective measures of employment
panel_all_sample2 <- panel_all_sample %>%
...
saveRDS(panel_all_sample2, file = "panel_var.rds")
panel_var <- file.choose()
panel_var <- readRDS(panel_var)

#Test for seeing if there is a loss of first borns
test_panel_all_sample <- panel_var %>%
