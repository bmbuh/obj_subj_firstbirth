...
a1m3f <- glm(formula = event ~ t3 + empstat2 + difficult*edu + agemn + agesq + immigrant + ol5cat + cci,
           family = binomial(link = "logit"),
           data = surv4f)
summary(a1m3f)
...
a1m4m <- glm(formula = event ~ t3 + empstat2 + difficult*edu + agemn + agesq + immigrant + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4m)
summary(a1m4m)
...
a1m4f <- glm(formula = event ~ t3 + empstat2 + difficult*edu + agemn + agesq + immigrant + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4f)
summary(a1m4f)
...
a2m3m <- glm(formula = event ~ t3 + empstat2 + worse*edu + agemn + agesq + immigrant + ol5cat + cci,
           family = binomial(link = "logit"),
           data = surv4m)
summary(a2m3m)
...
a2m3f <- glm(formula = event ~ t3 + empstat2 + worse*edu + agemn + agesq + immigrant + edu + ol5cat + cci,
           family = binomial(link = "logit"),
           data = surv4f)
summary(a2m3f)
...
a2m4m <- glm(formula = event ~ t3 + empstat2 + worse*edu + agemn + agesq + immigrant + edu + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4m)
summary(a2m4m)
...
a2m4f <- glm(formula = event ~ t3 + empstat2 + worse*edu + agemn + agesq + immigrant + edu + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4f)
summary(a2m4f)
...
a3m1m <- glm(formula = event ~ t3 + empstat2 + agemn + agesq + immigrant + edu + ol5cat,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m1m)
...
a3m1f <- glm(formula = event ~ t3 + empstat2 + agemn + agesq + immigrant + edu + ol5cat,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m1f)
...
a3m2m <- glm(formula = event ~ t3 + empstat2 + difficult + worse + agemn + agesq + immigrant + edu + ol5cat + cci,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m2m)
...
a3m2f <- glm(formula = event ~ t3 + empstat2 + difficult + worse + agemn + agesq + immigrant + edu + ol5cat + cci,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m2f)
...
a3m3m <- glm(formula = event ~ t3 + empstat2 + difficult*edu + worse*edu + agemn + agesq + immigrant + ol5cat + cci,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m3m)
...
a3m3f <- glm(formula = event ~ t3 + empstat2 + difficult*edu + worse*edu + agemn + agesq + immigrant + ol5cat + cci,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m3f)
...
a3m4m <- glm(formula = event ~ t3 + empstat2 + difficult*edu + worse*edu + agemn + agesq + immigrant + ol5cat + cci + combo,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m4m)
...
a3m4f <- glm(formula = event ~ t3 + empstat2 + difficult*edu + worse*edu + agemn + agesq + immigrant + ol5cat + cci + combo,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m4f)
