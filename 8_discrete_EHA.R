...
a1m3m <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4m)
summary(a1m3m)
summ(a1m3m, exp = TRUE) 
...
a1m3f <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + combo,
           family = binomial(link = "logit"),
           data = surv4f)
summary(a1m3f)
summ(a1m3f, exp = TRUE)
...
export_summs(a2m1m, a2m2m, a2m3m, a2m1f, a2m2f, a2m3f,
             ...
             exp = TRUE,
             to.file = "html",
             file.name = "A2_OR_S8_12-05-2022.html")
...
a3m1m <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + incquin,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m1m)
summ(a3m1m, exp = TRUE)
...
a3m1f <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + incquin,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m1f)
summ(a3m1f, exp = TRUE)
...
a3m2m <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + combo + incquin,
             family = binomial(link = "logit"),
             data = surv4m)
summary(a3m2m)
summ(a3m2m, exp = TRUE)
...
a3m2f <- glm(formula = event ~ t3 + empstat2 + difficult + edu + agemn + agesq + immigrant + ol5cat + cci + combo + incquin,
             family = binomial(link = "logit"),
             data = surv4f)
summary(a3m2f)
summ(a3m2f, exp = TRUE)
...
export_summs(a3m1m, a3m2m, a3m3m, a3m4m, a3m1f, a3m2f, a3m3f, a3m4f,
             ...
             exp = TRUE,
             to.file = "html",
             file.name = "A3_OR_S8_12-05-2022.html")
