...
# See the script "10_AME_draft1" for the first run of the script
...
## 4. Analysis 1 Model 3 + Income Quintile
...
#Empstat*Partner + Difficult
ma1m3f <- margins(a1m3f)
summary(ma1m3f)
plot(ma1m3f)

#Empstat*Partner + Difficult + Incquin
...
modelsummary(a1modf, coef_map = cm3, output = "A1diff_Women_AME_S10_20-07-2022.html", stars = TRUE)
...
modelsummary(a1modm, coef_map = cm3, output = "A1diff_Men_AME_S10_20-07-2022.html", stars = TRUE) 
a1diff_men <- modelsummary(a1modm, coef_map = cm3, output = "huxtable", stars = TRUE)
quick_docx(a1diff_men, file = "A1diff_men_AME_S10_20-07-2022.docx", open = FALSE)
quick_xlsx(a1diff_men, file = "A1diff_men_AME_S10_20-07-2022.xlsx", open = FALSE)
...
modelsummary(a1modb, coef_map = cm3, output = "A1diff_Both_AME_S10_20-07-2022.html", stars = TRUE) 
# modelsummary(a1modb, coef_map = cm3, output = "A1diff_Both_AME_S10_20-07-2022.docx", stars = TRUE) 
a1diff_both <- modelsummary(a1modb, coef_map = cm3, output = "huxtable", stars = TRUE)
quick_docx(a1diff_both, file = "A1diff_both_AME_S10_20-07-2022.docx", open = FALSE)
quick_xlsx(a1diff_both, file = "A1diff_both_AME_S10_20-07-2022.xlsx", open = FALSE)
...
#Empstat*Partner + Better 
ma2m3f <- margins(a2m3f)
summary(ma2m3f)
plot(ma2m3f)

#Empstat*Partner + Better  + Incquin
...
cm4 <- c("t3" = "Time since Education",
         ...
         "incquinFourth" = "Fourth Quintile",
         "incquinFifth" = "Fifth Quintile")
modelsummary(a2modf, coef_map = cm4, output = "A2better_Women_AME_S10_20-07-2022.html", stars = TRUE)
a2better_women <- modelsummary(a2modf, coef_map = cm4, output = "huxtable", stars = TRUE)
quick_docx(a2better_women, file = "a2better_Women_AME_S10_20-07-2022.docx", open = FALSE)
quick_xlsx(a2better_women, file = "a2better_Women_AME_S10_20-07-2022.xlsx", open = FALSE)
...
modelsummary(a2modm, coef_map = cm4, output = "A2better_Men_AME_S10_20-07-2022.html", stars = TRUE) 
a2better_men <- modelsummary(a2modm, coef_map = cm4, output = "huxtable", stars = TRUE)
quick_docx(a2better_men, file = "a2better_men_AME_S10_20-07-2022.docx", open = FALSE)
quick_xlsx(a2better_men, file = "a2better_men_AME_S10_20-07-2022.xlsx", open = FALSE)
...
modelsummary(a2modb, coef_map = cm4, output = "A2better_Both_AME_S10_20-07-2022.html", stars = TRUE) 
a2better_both <- modelsummary(a2modb, coef_map = cm4, output = "huxtable", stars = TRUE)
quick_docx(a2better_both, file = "a2better_both_AME_S10_20-07-2022.docx", open = FALSE)
quick_xlsx(a2better_both, file = "a2better_both_AME_S10_20-07-2022.xlsx", open = FALSE)
